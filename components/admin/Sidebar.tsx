...
const Sidebar: React.FC = () => {
  ...
  const menuItems = [
    ...
    {
      category: "Enquriy",
      categoryTitle: "Enquiry & Enrollment",
      items: ["List", "Add", "Enquiry List"],
    ...
    },
    {
      ...
      items: ["List", "Add", "Add Multiple", "ReOrder"],
      icon: "fa:arrow-circle-down",
      dropicon: "iconoir:nav-arrow-down",
    },
    {
      category: "Course Category",
      items: ["List", "Add", "Featured Category", "Featured Course Category"],
      icon: "fa:edit",
      dropicon: "iconoir:nav-arrow-down",
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        "Footer Management",
        "Footer Second Row",
        "Footer Second Columnn Menu",
        "Footer Third Menu Column",
      ],
      icon: "fa:tasks",
      dropicon: "iconoir:nav-arrow-down",
    },
    ...
    {
      category: "ACL",
      items: ["Roll", "Permission", "User Roll Mapping"],
      icon: "fa:calendar",
      dropicon: "iconoir:nav-arrow-down",
    },
  ];
        ...
        {menuItems.map((category, index) => (
          <div key={index} className="mb-6">
            {category.categoryTitle && (
              <h3 className="mb-4 text-primary-text-body font-poppins text-xs font-semibold">
                {category.categoryTitle}
              </h3>
            )}
            {category.items && category.items.length > 0 ? (
              <button
                ...
                className="w-full mb-2 flex items-center justify-between cursor-pointer"
              >
                <div className="flex items-center gap-2">
                  <div className="text-xs mb-0.5 text-gray-text-body">
                    <Icon icon={category.icon} />
                  </div>
                  <h3 className="text-xs font-medium text-gray-text-body font-poppins capitalize tracking-wide">
                    {category.category}
                  </h3>
                </div>
                <div
                  className={`text-sm text-gray-text-body transition-transform ease-in duration-200 ${
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="text-sm mb-0.5 text-gray-text-body">
                    <Icon icon={category.icon} />
                  </div>
                  <h3 className="text-xs font-medium text-gray-text-body font-poppins capitalize tracking-wide">
                    {category.category}
